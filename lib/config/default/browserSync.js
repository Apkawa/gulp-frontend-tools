...
function getBSOptions(options) {
    ...
    var bs_options = {
        ...
        server: {
            ...
            routes: {},
            middleware: [].concat(_toConsumableArray(buildProxyList(_lodash2.default.get(project, 'browserSync.proxy', {}))), _toConsumableArray(getWebpackMiddleware(webpack_options)))
        },
        plugins: []
    };
