...
function getBSOptions(options) {
    ...
    var bs_options = {
        ...
        server: {
            ...
            routes: {},
            middleware: [].concat(_toConsumableArray(buildProxyList(_lodash2.default.get(project, 'browserSync.proxy', {}))), [getWebpackMiddleware(_lodash2.default.get(project, 'browserSync.webpack.public_path'), webpack_options)])
        },
