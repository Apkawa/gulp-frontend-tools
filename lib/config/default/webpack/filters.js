...
function hotFilter(webpack_options, config) {
  var project_webpack = _lodash2.default.get(config, 'project.webpack', {});
...
function extractCss(webpack_options, config) {
  var extract_css = _lodash2.default.get(config, 'project.webpack.extract_css');
  if (extract_css) {
...
function definesFilter(webpack_options, config) {
  var defines = _lodash2.default.get(config, 'project.webpack.defines', {});
...
function bundleAnalyzerFilter(webpack_options, config) {
  var bundleAnalyzerOptions = _lodash2.default.get(config, 'project.webpack.bundle_analyzer');
...
function providePluginFilter(webpack_options, config) {
  var providePlugin = _lodash2.default.get(webpack_options, 'providePlugin', {});
...
function lodashFilter(webpack_options, config) {
  new _lodashWebpackPlugin2.default(_extends({
    ...
    'paths': true,
    'shorthands': true
  }, _lodash2.default.get(webpack_options, 'lodashPlugin')));
  delete webpack_options.lodashPlugin;
  return webpack_options;
}

exports.default = [productionFilter, hotFilter, definesFilter, sassFilter, providePluginFilter, extractCss, bundleAnalyzerFilter, lodashFilter];