...
exports.default = function (gulp, config) {
  ...
  function imagesStream(stream, imageminOptions) {
    ...
    imageminOptions = {
      plugins: [(0, _imageminJpegoptim2.default)({ progressive: true, max: 85 }), _gulpImagemin2.default.gifsicle(), _gulpImagemin2.default.optipng(), _gulpImagemin2.default.svgo()],
      verbose: true
    };
    return stream.pipe(imgFilter).pipe((0, _gulpIf2.default)(isProduction, (0, _gulpImagemin2.default)(imageminOptions.plugins, imageminOptions))).pipe((0, _gulpSize2.default)({ showFiles: true, gzip: true })).pipe(imgFilter.restore);
  }
  ...
  gulp.task('public', function () {
    var streams = _lodash2.default.map(PUBLIC_FILES, function (publicRoot) {
      ...
      var subStreams = _lodash2.default.map(filesGlob, function (_ref) {
        ...
        stream = imagesStream(stream, _gulpImagemin2.default);
