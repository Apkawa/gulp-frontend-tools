...
export default function (gulp, config) {
  ...
  gulp.task('sass', function () {
    ...
    let stream = gulp.src(SCSS_ROOT + '/**/*.scss')
  ...
  gulp.task('sass:lint', function () {
    ...
    return gulp.src(SCSS_ROOT || [APP_PATH.css + '**/[^_]*.scss', '!' + APP_PATH.css + 'base/_reset.scss'])
